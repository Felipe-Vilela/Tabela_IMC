...
// 		return resposta.json();
// 	}).then((dados) => {
// 		let btnRemover = document.querySelectorAll(".botaos_tabela_excluir");
		
// 		for(let i = 0; i < btnRemover.length; i++){
// 			// Associe o ID do objeto JSON ao botão como um atributo de dados
// 			// console.log(btnRemover[i].dataset.id)

// 			// btnRemover[i].addEventListener("click", function() {
// 			// 	// Recupere o ID do objeto JSON a partir do atributo de dados do botão
